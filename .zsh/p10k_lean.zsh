# Generated by Powerlevel10k configuration wizard on 2020-04-01 at 18:24 CEST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 31748.
# Wizard options: ascii, lean_8colors, 1 line, compact, concise, instant_prompt=off.
