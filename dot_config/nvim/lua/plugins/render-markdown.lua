return {

  {
    ...
    opts = {
      -- Render in normal and command mode (default false = normal only, which
      -- means raw markdown flashes back whenever you enter insert mode).
      -- "n" = normal, "c" = command. Add "i" if you want it in insert too,
      -- but that can feel noisy while actively typing.
      render_modes = { "n", "c" },
      heading = {
