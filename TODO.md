...
- [x] 9. Integrate 1Password SSH agent: configure `dot_ssh/private_config.tmpl` to point `IdentityAgent` to the 1Password socket, ensure the 1Password plugin in `antigen.zsh` is active, and verify private keys are not stored on disk
